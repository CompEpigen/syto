...
class DismirMLflowExperiment:
    ...
    def _find_chromosome_directories(self):
        ...
        # processed_chr = [f"chr{x}_cpg_counts_selected" for x in range(1,10,1)]
        # processed_chr = ["chr1_cpg_counts_selected", "chr2_cpg_counts_selected"]
    ...
    def _make_predictions_and_calculate_metrics(self, dismir_instance, split_name, chromosome):
        ...
        try:
            ...
            predictions,predictions_binary = dismir_instance.predict(dna,methylation_sequences=methylation)
            ...
            # try:
                ...
                for split in ['train', 'valid', 'test', 'rest']:
                    ...
                    metrics, predictions_df = self._make_predictions_and_calculate_metrics(
                        dismir_instance, split, chromosome
                    )
