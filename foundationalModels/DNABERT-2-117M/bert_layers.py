...
class BertUnpadSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        elif not config.use_triton:
            warnings.warn(
                "Triton is disabled by config, using default self-attention implementation"
            )
        else:
            warnings.warn("Using triton implementation of flash attention 2")
