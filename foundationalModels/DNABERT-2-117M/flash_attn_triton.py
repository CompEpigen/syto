...
def _fwd_kernel(
    ...
    for start_n in range(0, end_n, BLOCK_N):
        ...
        if BIAS_TYPE != "none":
            ...
            # # Adding clamping here to prevent numerical overflow:
            # qk = tl.maximum(tl.minimum(qk, 50.0), -50.0)  # Triton syntax
            ...
            # qk_scaled = tl.maximum(tl.minimum(qk_scaled, 50.0), -50.0)
            # m_ij = tl.maximum(qk_scaled, lse_i)
