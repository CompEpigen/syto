"""
Unit tests for methyldl.modelling.classifier_calibration_metrics.
...
from methyldl.modelling.classifier_calibration_metrics import (
    _compute_bin_edges,
    _assign_to_bins,
...
class TestComputeBinEdges(unittest.TestCase):
    ...
    def test_values_outside_range_issues_warning(self):
        ...
        with self.assertLogs(
            "methyldl.modelling.classifier_calibration_metrics", level="WARNING"
        ):
