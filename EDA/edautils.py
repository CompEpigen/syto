...
class DiagonalAwareDeconvolver(nn.Module):
    ...
    def __init__(
        ...
        self.combined_dim = self.diag_feature_dim + self.confusion_feature_dim + self.reject_feature_dim
    ...
    def get_feature_importance(
        ...
        if self.use_diagonal:
            importance['diagonal_importance'] = x.grad[:, :, :self.n_dmr].diagonal(dim1=1, dim2=2).detach()
